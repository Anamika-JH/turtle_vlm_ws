...
class LLMInterface:
    def __init__(self, destinations: Dict[str, Any]):
        self.destinations = destinations

    def call_llm(self, system_message: str, prompt: str) -> str:
        headers = {
            "Content-Type": "application/json",
            "User-Agent": "ros-llama3-client"
        }
        data = {
            "model": "llama3",
        ...
        response = requests.post("http://localhost:11434/api/generate", json=data, timeout=180)
    ...
    def get_system_message_status(self, current_yaw: str, cardinal_direction: str, 
        ...
        return (
            "You are Turtle, a physical ROS based mobile robot. You are equipped with sensors and actuators. Your maximum and minimum movement speed are 1.0 m/s and 0.2 m/s respectively, "
    ...
    def get_example_messages(self) -> str:
        return (
            ...
            "Turtle: Action 1: Describe surroundings.\n"
            ...
            "\nUser: Rotate 45 degrees clockwise.\n"
            "Turtle:\n"
            "Action 1: Rotate 45 degrees clockwise.\n"
            "\nUser: Rotate 90 degrees counter-clockwise.\n"
            "Turtle:\n"
            "Action 1: Rotate 90 degrees counter-clockwise.\n"
